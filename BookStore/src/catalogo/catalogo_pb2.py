...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SUCCESSMESSAGE']._serialized_end=356
  _globals['_SHOWCATALOGO']._serialized_start=359
  _globals['_SHOWCATALOGO']._serialized_end=499
