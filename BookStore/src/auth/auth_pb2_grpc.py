...
class UserAuthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                '/auth.UserAuth/CreateUser',
                request_serializer=auth__pb2.UserData.SerializeToString,
                response_deserializer=auth__pb2.LoginResponse.FromString,
                _registered_method=True)
        self.LoginUser = channel.unary_unary(
                '/auth.UserAuth/LoginUser',
                request_serializer=auth__pb2.UserData.SerializeToString,
                response_deserializer=auth__pb2.LoginResponse.FromString,
                _registered_method=True)
...
def add_UserAuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateUser': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateUser,
                    request_deserializer=auth__pb2.UserData.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'auth.UserAuth', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('auth.UserAuth', rpc_method_handlers)
...
class UserAuth(object):
    ...
    def CreateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.UserAuth/CreateUser',
            auth__pb2.UserData.SerializeToString,
